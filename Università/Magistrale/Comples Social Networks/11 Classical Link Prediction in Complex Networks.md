...
Dato un grafo $G=(V,E)$ dove $V$ è l'insieme dei nodi ed $E$ l'insieme degli archi osservati:
* Trovare coppie di nodi $(u, v)$ tali che $(u, v) \notin E$ (Static/Future Prediction).
* L'obiettivo è **classificare** o **ordinare (rank)** tutti i link non osservati in base alla loro probabilità di esistere.
...
Per valutare un classificatore binario, confrontiamo le predizioni con la realtà (Ground Truth):
...
Le metriche standard derivate dalla matrice di confusione sono:
