...
![[pdf2.pdf#page=2&rect=102,99,267,164|pdf2, p.2|550]]
...
> Data $L=\frac{1}{2}\sum_{i=1}^Nk_{i}$ sostituendo in $\langle k \rangle = \frac{1}{N}\sum_{i=1}^Nk_{i}$, essendo $\sum_{i=1}^Nk_{i}=2L$ sarà:$$\langle k \rangle = \frac{2L}{N}$$
### Distribuzione dei gradi 

La funzione **distribuzione dei gradi** $p_{k}$ fornisce la probabilità che un nodo selezionato radicamento nella rete abbia grado $k$. 
...
![[pdf2.pdf#page=8&rect=53,11,321,210|pdf2, p.8|450]]
...
![[pdf2.pdf#page=22&rect=36,27,314,210|pdf2, p.22|550]]
## Percorsi e Distanze
...
- Il percorso più corto tra due nodi $i$ e $j$ il percorso con il numero minore di collegamenti. Questo viene indicato come **distanza tra i due nodi** $i$ e $j$ espresso come $d_{i,j}$
...
![[pdf2.pdf#page=27&rect=59,47,304,175|pdf2, p.27]]
### Connessione (Connectedness)
...
![[pdf2.pdf#page=30&rect=35,59,241,167|pdf2, p.30]]
...
![[pdf2.pdf#page=33&rect=76,21,278,114|pdf2, p.33]]
