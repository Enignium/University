...
Due nodi sono più simili se:

- Esistono percorsi che li collegano
- Più i percorsi sono brevi, più pesano
- Contano anche i percorsi lunghi, purchè pesati meno 

Katz non usa solo i vicini di primo grado o il grado dei nodi: usa **l’intera struttura del grafo** → è una misura globale.
